...
class UserRepositoryImpl extends UserRepository {
  ...
  @override
  Future<Either<Failure, String>> registerUser(String name, String email, String password) async {
    try {
      var registUser = await firebaseAuth.createUserWithEmailAndPassword(email: email, password: password);
